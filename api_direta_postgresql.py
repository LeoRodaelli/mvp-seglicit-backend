#!/usr/bin/env python3
"""
API direta usando psycopg2 sem SQLAlchemy
"""

import os


def criar_api_direta():
    """Cria API que usa psycopg2 diretamente"""
...
'''
    ...
    # Salvar arquivo
    rotas_file = "src/routes/tender.py"

    with open(rotas_file, "w", encoding="utf-8") as f:
        f.write(api_content)

    print("✅ API direta com psycopg2 criada")


if __name__ == "__main__":
    print("🔧 Criando API direta com psycopg2...")
    criar_api_direta()
    print("\\n🎉 API direta criada!")
    print("\\n📋 Esta solução:")
    print("- Usa psycopg2 diretamente")
    print("- Não usa SQLAlchemy")
    print("- Contorna problemas de encoding")
    print("\\n🚀 Agora:")
    print("1. Pare o backend (Ctrl+C)")
    print("2. Execute: iniciar_backend.bat")
    print("3. Teste: http://localhost:5000/api/test")
