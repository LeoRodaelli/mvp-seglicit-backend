...
KEYWORDS_POR_AREA = {
    ...
    "Seguros": [
        "seguro", "seguros", "apólice", "apolice", "apólices", "apolices",
        "seguradora", "seguradoras", "corretora de seguros", "corretor de seguros",
        "corretagem de seguros", "serviço de corretagem", "servico de corretagem",
        "seguro de vida", "seguro de vida em grupo", "seguro de acidentes pessoais",
        "seguro patrimonial", "seguro empresarial", "seguro residencial", "seguro predial",
        "seguro condominial", "seguro de frota", "seguro veicular", "seguro de veículos",
        "seguro de veiculos", "seguro auto", "seguro automóvel", "seguro automovel",
        "seguro de responsabilidade civil", "seguro rc", "seguro d&o",
        "seguro de administradores", "responsabilidade civil profissional",
        "seguro garantia", "seguro-garantia", "garantia contratual", "carta de fiança",
        "carta de fianca", "seguro fiança", "seguro fianca", "seguro-fiança",
        "seguro-fianca", "fiança locatícia", "fianca locaticia",
        "seguro-fiança locatícia", "seguro-fianca locaticia",
        "seguro de obras", "seguro de engenharia", "seguro de riscos de engenharia",
        "seguro risco de engenharia", "seguro contra incêndio", "seguro contra incendio",
        "seguro incêndio", "seguro incendio", "seguro contra roubo",
        "seguro contra roubo e furto", "seguro de transporte", "seguro de carga",
        "seguro de transporte de valores", "seguro de valores", "seguro educacional",
        "seguro cyber", "seguro de riscos cibernéticos", "seguro riscos ciberneticos",
        "sinistro", "sinistros", "prêmio de seguro", "premio de seguro",
        "prêmio securitário", "premio securitario", "cobertura securitária",
        "cobertura securitaria", "cobertura de seguro", "apólice de seguro",
        "apolice de seguro", "contratação de seguro", "contratacao de seguro",
        "contratação de seguradora", "contratacao de seguradora", "resseguro",
        "resseguradora", "susep", "superintendência de seguros privados",
        "superintendencia de seguros privados", "seguro de equipamentos",
        "seguro de máquinas e equipamentos", "seguro de maquinas e equipamentos",
        "seguro obrigatório", "seguro obrigatorio", "vida em grupo",
    ],
}
...
def disparar_webhooks_nova_licitacao(licitacao_dict):
    ...
    Dispara email + webhook Zaia para assinantes cujo plano corresponde.
    """
    from src.services.tender_notification_service import notify_users_of_new_tender
    notify_users_of_new_tender(licitacao_dict)
